...
ENV DENODO_EXT_META_DB_PROP_FILE=${DENODO_HOME}/conf/metadb.properties

ENV DENODO_START_VQL_SERVER=true
ENV DENODO_START_DESIGN_STUDIO=true
ENV DENODO_START_SCHEDULER=true
ENV DENODO_START_SCHEDULER_WEB_ADMIN=true
ENV DENODO_START_INDEXING_SERVER=true
ENV DENODO_START_DATA_CATALOG=true
ENV DENODO_START_DIAGNOSTIC_AND_MONITORING=true
ENV DENODO_USE_EXTERNAL_METADATA=false
